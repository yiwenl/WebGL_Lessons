...
// adding a new varying for the noise 
// we are going to use thsi in the fragment shader to color the cubes
varying float vNoise;


// you can find all kinds of noise function here : 
// https://gist.github.com/patriciogonzalezvivo/670c22f3966e662d2f83
// I'm using the 'Simplex 3D Noise'
...
void main() {
  ...
  float noise = snoise(uTranslate * 0.05 + uTime * 0.2);
