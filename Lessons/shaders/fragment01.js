...
// we are not using this vColor for now
varying vec3 vColor;
...
void main() {
  // the position of our square goes from -5 ~ 5
  // now map it to 0 ~ 1
  float r = map(uTranslate.x, -5.0, 5.0, 0.0, 1.0);
  float g = map(uTranslate.y, -5.0, 5.0, 0.0, 1.0);
